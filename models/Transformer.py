...
class Transformer(nn.Module):
    ...
    def __init__(self, model_name_or_path: str, max_seq_length: Optional[int] = None,
        ...
        config = RoFormerConfig.from_pretrained(model_name_or_path, **model_args, cache_dir=cache_dir)
        self.tokenizer = RoFormerTokenizer.from_pretrained(model_name_or_path, cache_dir=cache_dir, **tokenizer_args)
        self.auto_model = RoFormerModel.from_pretrained(model_name_or_path, config=config, cache_dir=cache_dir)
